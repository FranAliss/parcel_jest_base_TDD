import CowsAndBullsController from "./controller.js";
...
saveButton.addEventListener("click", (event) => {
  ...
  codeString.innerHTML =
    "<p>La clave secreta es: " +
    codeNumber +
...
guessButton.addEventListener("click", (event) => {
  event.preventDefault();
  guessString.innerHTML = gameController.getGuessAnswerHTML(
    String(codeTry.value)
  );
  gameController.fillHTMLObjwithHistory(codesAlreadyWritten);
  gameController.updateLifesHTML(LifesValue);
});
